...
if __name__ == '__main__':
    ...
    for sitescope in sitescopes:
        ...
        print (str(datetime.now()) + '\t'+ sitescope + '\tProcessando arquivos de log...')
        dic_alertas = popula_alertas(sitescope)

        print (str(datetime.now()) + '\t' + sitescope + '\tFormatando saida...')
        gerar_arquivo_alertas(dic_alertas, sitescope)

        #print (str(datetime.now()) + '\t' + sitescope + '\tGerando monitores...')
        #gerar_arquivo_unicos(dic_alertas, sitescope)

        print (str(datetime.now())+ '\t' + '\tTERMINADO')
